...
<div class="websiteWrapper"> 
  ...
  <div class="pageWrapper homePageWrapper"> 
    ...
    <div class="pageContentWrapper">
      ...
      <h3 class="homePageTitle">Welcome to our website!</h3>

      <div class="pageBreak"></div>

      <!-- recent projects outer wrapper starts -->

      <div class="recentProjectsOuterWrapper"> 

        <!-- recent projects wrapper starts -->

        <div class="recentProjectsWrapper">

          <h4 class="recentProjectsTitle">Recent Projects</h4>
        ...
        <!-- recent projects wrapper ends --> 

      </div>

      <!-- recent projects outer wrapper ends -->
        ...
        <div class="accordionItemWrapper"> <a href="" class="accordionButton"><span class="accordionButtonIcon"></span><span class="accordionButtonTitle">How many pages are included?</span></a>
          ...
          <div class="accordionContentWrapper">
            ...
            <div class="accordionContent">
              ...
              <p>This template has 12 unique pages.</p>
